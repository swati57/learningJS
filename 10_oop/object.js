...
//adding your own methods to protype
...
//if new is not used here, the above injected function can not be accessed by object
const userA = new createUser("a", 25)
const userB = new createUser("b", 34)
